...
export const PASTAS: Pasta[] = [
  {
    ...
    recipe: {
      ...
      steps: [
        ...
        "타이머가 울리면 면수 반 컵을 팬에 붓고, 면을 건져 팬에서 30초간 뒤섞어요.",
        "소금으로 간을 맞추고 파슬리를 뿌려 마무리해요.",
      ],
      tip: "면수의 전분이 기름과 만나야 소스가 뽀얗게 엉겨요. 면수는 버리지 말 것!",
    },
  },
  {
    slug: "capellini",
  ...
  },
  {
    ...
    recipe: {
      ...
      steps: [
        "방울토마토를 반으로 잘라 두어요.",
        "큰 볼에 페스토와 올리브유를 섞어요.",
        "잣을 마른 팬에 살짝 볶아 고소함을 올려요.",
        "타이머가 울리면 면을 건져 볼에 넣고 버무려요. 불에 올리지 않아요.",
        "토마토, 잣, 치즈를 올려 마무리해요.",
      ],
      tip: "페스토는 열에 닿으면 향이 죽어요. 꼭 볼에서 버무리기!",
    },
  },
  {
    slug: "rigatoni",
  ...
  },
  {
    ...
    recipe: {
      title: "브로콜리 마늘 파스타",
      intro: "브로콜리를 면과 같은 냄비에 삶는, 설거지 아끼는 레시피예요.",
      ingredients: [
